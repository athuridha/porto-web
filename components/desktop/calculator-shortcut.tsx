...
export function CalculatorShortcut({ onDoubleClick }: CalculatorShortcutProps) {
  const handleClick = () => {
    onDoubleClick()
  }
  ...
  return (
    <div className="absolute top-8 right-4 md:right-8 animate-in fade-in duration-500 delay-1200">
      ...
      >
        <div className="w-12 h-12 md:w-16 md:h-16 bg-orange-500 rounded-lg flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform duration-200">
